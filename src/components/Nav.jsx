...
export default function Nav(params) {
  ...
  return (
    <nav className="h-max sticky">
      <div
        onClick={() => setIsMenuOpened(false)}
        className={`z-10 h-full w-full ${isMenuOpened ? "fixed" : "hidden"}`}
      ></div>
      <div className="z-20 sticky bg-[#172030] border-b border-[#2E3745] w-full font-[Poppins] flex flex-col gap-2">
        <div className={`stick z-30 flex p-4 pl-3 justify-between bg-[#172030] border-b  border-[#2E3745] ${isMenuOpened && "border-[#2e374500]"} transition-all duration-100`}>
        ...
        {/*Mobile navigation */}
        {true && (
          <div className={` md:hidden ${isMenuOpened ? "mt-0" : "-mt-[150%] opacity-0"} tranistion-all duration-500 ease-out`}>
            <div>
